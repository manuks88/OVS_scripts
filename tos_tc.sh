...
#	ssh duke1 "nping --tcp -S 10.1.1.121 --dest-ip 10.1.1.233 --dest-port 15000 --source-port 15000 --dest-mac 00:07:43:3c:b0:50 --source-mac 00:07:43:04:b2:c8 -c 3000 --rate 1000 --tos $i &> /dev/null" &
#	sleep 1
#	check_hit
#}
#
...
#	fi
#	echo $tos_val
#        /root/iproute2/tc/tc filter add dev ens2f4 parent ffff: protocol ipv4 pref 5 flower skip_sw src_ip 10.1.1.121 dst_ip 10.1.1.233 ip_proto tcp src_port 15000 dst_port 15000 ip_tos $tos_val action mirred egress redirect dev ens2f4d1
#	ssh duke1 "nping --tcp -S 10.1.1.121 --dest-ip 10.1.1.233 --dest-port 15000 --source-port 15000 --dest-mac 00:07:43:3c:b0:50 --source-mac 00:07:43:04:b2:c8 -c 3000 --rate 1000 --tos $i &> /dev/null" &
#	sleep 1
#	check_hit
#}
...
#	ssh duke1 "nping --tcp -S 10.1.1.121 --dest-ip 10.1.1.233 --dest-port 15000 --source-port 15000 --dest-mac 00:07:43:3c:b0:50 --source-mac 00:07:43:04:b2:c8 -c 3000 --rate 1000 --tos $i --mf &> /dev/null" &
#	sleep 1
#	check_hit
#}
#
...
#	ssh duke1 "nping --tcp -S 10.1.1.121 --dest-ip 10.1.1.233 --dest-port 15000 --source-port 15000 --dest-mac 00:07:43:3c:b0:50 --source-mac 00:07:43:04:b2:c8 -c 3000 --rate 1000 --tos $i --df &> /dev/null" &
#	sleep 1
#	check_hit
#}
...
for i in 0 32 40 56 72 88 96 112 136 144 152 160 184 192
{
	...
	echo $tos_val
        /root/iproute2/tc/tc filter add dev ens2f4 parent ffff: protocol ipv4 pref 5 flower skip_sw src_ip 10.1.1.121 dst_ip 10.1.1.233 ip_proto tcp src_port 15000 dst_port 15000 ip_tos $tos_val ip_flags nofrag action mirred egress redirect dev ens2f4d1
	ssh duke1 "nping --tcp -S 10.1.1.121 --dest-ip 10.1.1.233 --dest-port 15000 --source-port 15000 --dest-mac 00:07:43:3c:b0:50 --source-mac 00:07:43:04:b2:c8 -c 3000 --rate 1000 --tos $i --df &> /dev/null" &
	sleep 1
	check_hit
}
